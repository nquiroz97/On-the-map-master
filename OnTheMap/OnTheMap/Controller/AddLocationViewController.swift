...
//  OnTheMap
//
//  Created by Neri Quiroz on 11/23/20.
//
...
class AddLocationViewController: UIViewController, UITextFieldDelegate {
    ...
    private func buildStudentInfo(_ coordinate: CLLocationCoordinate2D) -> StudentsLocations{
        ...
        return StudentsLocations(studentInfo)
